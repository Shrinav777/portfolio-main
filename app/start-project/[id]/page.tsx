...
// import { projects } from "@/data/siteData.json"; // Adjust this path to your siteData.json location

// export async function generateStaticParams() {
//   // This tells Render to create a static page for every project ID
...
//             className={`w-3 h-3 rounded-full transition-all duration-300 hover:scale-125 ${index === currentIndex ? 'bg-primary scale-110' : 'bg-white/60 hover:bg-white/80'
//               }`}
//           />
//         ))}
//       </div>
...
//   const project = siteData.projects[projectIndex] as ProjectData | undefined
...
// 1. This tells Render exactly which project pages to build at compile time
export async function generateStaticParams() {
...
// 2. This function fetches the data on the server
export default function Page({ params }: { params: { id: string } }) {
  const project = siteData.projects.find((p: any) => p.id.toString() === params.id)

  if (!project) {
    return notFound()
  }

  // 3. Pass the project data to the Client UI component
